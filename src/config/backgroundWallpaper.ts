...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
			"assets/images/GGBondDesktop/GGBond1.avif",
			"assets/images/GGBondDesktop/GGBond2.avif",
			"assets/images/GGBondDesktop/GGBond3.avif",
			"assets/images/GGBondDesktop/GGBond4.avif",
			"assets/images/GGBondDesktop/GGBond5.avif",
			"assets/images/GGBondDesktop/GGBond6.avif",
		],
		// 移动背景图片（支持单张或多张随机）
	...
	common: {
		...
		homeText: {
			...
			enable: true,
			// 主页横幅主标题
			title: "欢迎来到GGBond Lab",
			// 主页横幅主标题字体大小
			titleSize: "4.5rem",
			// 主页横幅副标题
			subtitle: [
				"先完成，再完美",
				"不要拿自己的第一天和别人的第一千天去比较",
				"“不可能”这三个字你说的太多了",
				"虽然辛苦，我还是会选择那种滚烫的人生",
				"你所厌恶的今天，是昨天死去之人奢望的明天",
				"你所浪费的现在，是未来的你回不去的曾经",
			],
			// 主页横幅副标题字体大小
			subtitleSize: "1.5rem",
			...
			links: [
				{
					...
					url: "https://github.com/ggbob888/GGBond",
					showName: true,
				},
				{
					name: "Email",
					icon: "fa7-solid:envelope",
					url: "mailto:1187936812@qq.com",
				},
				{
					name: "Sponsor",
